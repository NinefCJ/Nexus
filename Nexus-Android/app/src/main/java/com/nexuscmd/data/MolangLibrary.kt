...
object MolangLibrary {
    val properties = listOf(
        ...
        MolangItem("query.is_dancing", "是否跳舞", "实体是否在跳舞"),
        MolangItem("query.is_celebrating", "是否庆祝", "实体是否在庆祝"),
        MolangItem("query.is_emoting", "是否做表情", "实体是否在做表情"),
        MolangItem("query.is_using_item", "是否使用物品", "实体是否正在使用物品"),
        MolangItem("query.is_holding_shield", "是否持盾", "实体是否持有盾牌"),
        MolangItem("query.is_crouching", "是否蹲下", "实体是否蹲下"),
        MolangItem("query.is_elytra_flying", "是否鞘翅飞行", "玩家是否使用鞘翅飞行"),
        MolangItem("query.is_fishing", "是否钓鱼", "玩家是否在钓鱼"),
        MolangItem("query.is_bow_loaded", "弓是否拉满", "玩家弓是否拉满"),
        MolangItem("query.is_crossbow_loaded", "弩是否装填", "玩家弩是否装填"),
        MolangItem("query.is_trident_thrown", "三叉戟是否投掷", "三叉戟是否已投掷"),
        MolangItem("query.is_totem_active", "图腾是否激活", "不死图腾是否激活"),
        MolangItem("query.is_on_ground", "是否在地面", "实体是否接触地面"),
        MolangItem("query.is_underwater", "是否在水下", "实体是否在水下"),
        MolangItem("query.is_in_clouds", "是否在云层", "实体是否在云层中"),
        MolangItem("query.is_in_void", "是否在虚空", "实体是否在虚空中"),
        MolangItem("query.light_level", "光照等级", "实体所在位置光照等级"),
        MolangItem("query.block_light", "方块光照", "方块光照等级"),
        MolangItem("query.sky_light", "天空光照", "天空光照等级"),
        MolangItem("query.temperature", "温度", "实体所在位置温度"),
        MolangItem("query.humidity", "湿度", "实体所在位置湿度"),
        MolangItem("query.biome", "生物群系", "实体所在生物群系"),
        MolangItem("query.dimension", "维度", "实体所在维度"),
