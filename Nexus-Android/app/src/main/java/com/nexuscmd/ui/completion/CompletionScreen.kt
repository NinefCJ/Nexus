...
import com.nexuscmd.android.widget.CommandEditText
import com.nexuscmd.core.SelectedString
import com.nexuscmd.core.Theme
import com.nexuscmd.data.SettingsDataStore
import com.nexuscmd.ui.HistoryScreenKey
import com.nexuscmd.ui.LocalLibraryListScreenKey
import com.nexuscmd.ui.PublicLibraryListScreenKey
...
//    val syntaxHighlightBoolean = NexusTheme.colors.syntaxHighlightBoolean
//    val syntaxHighlightFloat = NexusTheme.colors.syntaxHighlightFloat
//    val syntaxHighlightInteger = NexusTheme.colors.syntaxHighlightInteger
//    val syntaxHighlightSymbol = NexusTheme.colors.syntaxHighlightSymbol
//    val syntaxHighlightId = NexusTheme.colors.syntaxHighlightId
//    val syntaxHighlightTargetSelector = NexusTheme.colors.syntaxHighlightTargetSelector
//    val syntaxHighlightCommand = NexusTheme.colors.syntaxHighlightCommand
//    val syntaxHighlightBrackets1 = NexusTheme.colors.syntaxHighlightBrackets1
//    val syntaxHighlightBrackets2 = NexusTheme.colors.syntaxHighlightBrackets2
//    val syntaxHighlightBrackets3 = NexusTheme.colors.syntaxHighlightBrackets3
//    val syntaxHighlightString = NexusTheme.colors.syntaxHighlightString
//    val syntaxHighlightNull = NexusTheme.colors.syntaxHighlightNull
//    val syntaxHighlightRange = NexusTheme.colors.syntaxHighlightRange
//    val syntaxHighlightLiteral = NexusTheme.colors.syntaxHighlightLiteral
...
//        }
//    }
//    val underlineErrorReason = NexusTheme.colors.underlineErrorReason
...
//        },
//        textStyle = TextStyle(
//            color = NexusTheme.colors.textMain,
//            fontSize = 16.sp,
//            textAlign = TextAlign.Start,
//        ),
//        outputTransformation = outputTransform,
//        cursorBrush = SolidColor(NexusTheme.colors.mainColor),
...
//                        style = TextStyle(
//                            color = NexusTheme.colors.textHint,
//                        ),
//                    )
//                }
//            }
...
//                )
                val theme = NexusTheme.theme
                val textMain = NexusTheme.colors.textMain
                val textSecondary = NexusTheme.colors.textSecondary
                ...
                AndroidView(
                    ...
                    factory = { context ->
                        CommandEditText(context).apply {
                            ...
                            setTheme(if (theme == NexusTheme.Theme.Light) Theme.THEME_DAY else Theme.THEME_NIGHT)
