...
import com.nexuscmd.ui.library.mcd.MCDLineResult
        ...
        DialogContainer(
            ...
            Column(
                ...
                Text(
                    ...
                    style = TextStyle(fontSize = 13.sp, color = NexusTheme.colors.textSecondary)
                )
...
private fun LowCodeChip(text: String, selected: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            .clip(RoundedCornerShape(4.dp))
            .background(if (selected) Color(0xFFE65100) else NexusTheme.colors.backgroundComponentNoTranslate)
            .clickable { onClick() }
        ...
        Text(
            ...
            style = TextStyle(
                fontSize = 11.sp,
                color = if (selected) Color.White else NexusTheme.colors.textMain,
