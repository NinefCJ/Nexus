        ...
        Column(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Box(
                            modifier = Modifier
                                ...
                                .background(
                                    if (uploadEnabled) NexusTheme.colors.mainColor.copy(alpha = 0.12f)
                            ...
                            Text(
                                ...
                                style = TextStyle(
                                    fontSize = 13.sp,
                                    color = if (uploadEnabled) NexusTheme.colors.mainColor
            ...
            Row(
                ...
                Box(
                    ...
                    Text("取消", style = TextStyle(color = NexusTheme.colors.textSecondary))
                }
                Spacer(modifier = Modifier.width(8.dp))
