...
import com.nexuscmd.ui.MessageScreenKey
...
import com.nexuscmd.ui.common.widget.TextFieldWithIcon
import com.nexuscmd.ui.library.profile.EditProfileDialog
        ...
        if (profile == null) {
            ...
            Dialog(onDismissRequest = {
                ...
                Box(
                    ...
                    Text(
                        text = "正在加载资料…",
                        style = TextStyle(color = NexusTheme.colors.textMain)
                    )
                }
            }
        } else {
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                ...
                .background(
                    NexusTheme.colors.backgroundComponentNoTranslate,
                ...
                Box(
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxSize()
                            .clip(CircleShape)
                            .background(if (viewModel.isUploadingAvatar) NexusTheme.colors.backgroundComponentNoTranslate else NexusTheme.colors.backgroundComponent)
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
                ...
                style = TextStyle(color = NexusTheme.colors.textSecondary, fontSize = 12.sp)
            )
        }
        Icon(
            id = R.drawable.x,
            ...
            Column(modifier = Modifier.padding(24.dp)) {
                ...
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(48.dp)
                        .background(NexusTheme.colors.background, RoundedCornerShape(24.dp))
                        .padding(4.dp)
                ) {
...
fun RowScope.TabPill(text: String, selected: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            ...
            .fillMaxHeight()
            .clip(RoundedCornerShape(20.dp))
            .background(if (selected) NexusTheme.colors.backgroundComponentNoTranslate else Color.Transparent)
            .clickable(onClick = onClick),
        contentAlignment = Alignment.Center
    ) {
        Text(
            text = text,
            style = TextStyle(
                color = if (selected) NexusTheme.colors.textMain else NexusTheme.colors.textSecondary,
