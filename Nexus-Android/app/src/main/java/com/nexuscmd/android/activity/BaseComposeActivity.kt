...
package com.nexuscmd.android.activity
...
abstract class BaseComposeActivity : ComponentActivity() {
    ...
    protected var theme by mutableStateOf(NexusTheme.Theme.Light)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            settingsDataStore.themeId().collect { themeId ->
                ...
                val isDarkMode = theme == NexusTheme.Theme.Dark
        ...
        if (existingComposeView != null) {
            ...
            ComposeView(this).apply {
                ...
                setContent {
                    ...
                    NexusTheme(theme, backgroundBitmap.value) {
                        content()
                    }
                }
                setOwners()
