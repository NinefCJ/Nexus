...
namespace Nexus::Test {
    ...
    const char *getTokenTypeStr(const Nexus::TokenType::TokenType &tokenType) {
        switch (tokenType) {
            case Nexus::TokenType::NUMBER:
                return "NUMBER";
            case Nexus::TokenType::STRING:
                return "STRING";
            case Nexus::TokenType::SYMBOL:
                return "SYMBOL";
            case Nexus::TokenType::SPACE:
                return "WHITESPACE";
            default:
                return "UNKNOWN";
        }
