...
void testCommand(Nexus::CHelperCore *core, const std::u16string &command) {
    core->onTextChanged(command, command.length());
    Nexus::SyntaxHighlight::SyntaxResult syntaxResult = core->getSyntaxResult();
    ...
    for (size_t i = 0; i < syntaxResult.tokenTypes.size(); ++i) {
        ...
        switch (tokenType) {
            case Nexus::SyntaxHighlight::SyntaxTokenType::UNKNOWN:
                color = colorUnknown;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::BOOLEAN:
                color = colorBoolean;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::FLOAT:
                color = colorFloat;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::INTEGER:
                color = colorInteger;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::SYMBOL:
                color = colorSymbol;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::ID:
                color = colorId;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::TARGET_SELECTOR:
                color = colorTargetSelector;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::COMMAND:
                color = colorCommand;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::BRACKET1:
                color = colorBrackets1;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::BRACKET2:
                color = colorBrackets2;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::BRACKET3:
                color = colorBrackets3;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::STRING:
                color = colorString;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::NULL_TOKEN:
                color = colorNull;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::RANGE:
                color = colorRange;
                break;
            case Nexus::SyntaxHighlight::SyntaxTokenType::LITERAL:
                color = colorLiteral;
                break;
            default:
                break;
...
TEST(ColorStringTest, ColorString) {
    ...
    Nexus::CHelperCore *core = Nexus::CHelperCore::createByDirectory(
