...
#define CHELPER_GET_NAME(v1) \
    case NodeTypeId::v1:     \
        return NodeTypeDetail<Nexus::Node::NodeTypeId::v1>::name;

#define CHELPER_GET_NODE_TYPE_BY_NAME(v1)                                             \
    if (Nexus::Node::NodeTypeDetail<Nexus::Node::NodeTypeId::v1>::name == name) { \
        return Nexus::Node::NodeTypeId::v1;                                         \
    }

namespace Nexus::Node {
